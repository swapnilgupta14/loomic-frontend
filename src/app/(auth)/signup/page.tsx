      ...
      <Card className="w-full max-w-md relative z-10 glass-card shadow-2xl">
        <CardHeader className="space-y-3 text-center">
          <div className="flex justify-center mb-2">
            <div className="p-3 rounded-2xl bg-clr-secondary-subtle border border-clr-border">
              <Sparkles className="h-8 w-8 text-clr-secondary" />
            </div>
          </div>
          <CardTitle className="text-3xl font-bold gradient-secondary">
            Create Account
          </CardTitle>
          <CardDescription className="text-clr-muted-foreground text-base">
            Join Loomic and start creating
          </CardDescription>
        </CardHeader>
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="name" className="text-clr-foreground">
                Full Name
              </Label>
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-clr-muted-foreground pointer-events-none" />
                <Input
                  id="name"
                  name="name"
                  type="text"
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-clr-muted-foreground">
                Must be at least 8 characters
              </p>
            </div>

            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-clr-foreground">
                Confirm Password
              </Label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-clr-muted-foreground pointer-events-none" />
            ...
            <p className="text-xs text-center text-clr-muted-foreground">
              ...
              <Link href="/terms" className="text-clr-primary hover:underline">
                Terms of Service
              </Link>{" "}
              and{" "}
              <Link href="/privacy" className="text-clr-primary hover:underline">
                Privacy Policy
              </Link>
            </p>
          </CardContent>
